...
public class ConfigLoader {
  ...
  private void loadProperties(Path f) throws IOException {
    ...
    for (String k : props.stringPropertyNames()) {
      values.put(k, props.getProperty(k));
    }
  }
  ...
  private void flatten(String prefix, Object o) {
    if (o instanceof Map) {
      ...
      for (Map.Entry<Object, Object> e : m.entrySet()) {
        ...
        flatten(k, e.getValue());
      }
    } else {
      values.put(prefix, String.valueOf(o));
    }
  }
  ...
  public String resolvePlaceholders(String v) {
    ...
    for (int i = 0; i < 5; i++) {
      ...
      String rep = values.getOrDefault(key, "");
      out = out.substring(0, s) + rep + out.substring(e + 1);
    }
    return out;
  }
}